# 🗡️ Sword Art Online & SAO Progressive - Full Arabic Edition
...
<details>
<summary><strong>❓ كيف أضيف مجلداً جديداً؟</strong></summary>

```bash
1. ادخل للوحة التحكم: /admin-panel
2. اختر "رفع مجلد جديد"
3. حدد السلسلة (SAO/Progressive/Side Works)
4. ارفع صفحات المجلد (JPG/PNG مفضل)
...
<details>
<summary><strong>🔧 التطبيق لا يعمل بدون اتصال؟</strong></summary>

```
تأكد من:
- زيارة المجلدات أثناء الاتصال بالإنترنت أولاً
- السماح للتطبيق بالتخ��ين المحلي
...
<details>
<summary><strong>💰 كيف أفعل Google AdSense؟</strong></summary>

```typescript
1. احصل على حساب AdSense مقبول
2. استبدل معرف الناشر في client/config/adsense.ts
3. حدث إعدادات الإعلانات حسب تفضيلاتك
...
<details>
<summary><strong>🛡️ نظام الحماية يتداخل مع الاستخدام العادي؟</strong></summary>

```typescript
// للمديرين فقط: تعطيل مؤقت للحماية
await disableSecurity("MrPheonixX-Admin-2024");
