        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
            ...
            <Card className="p-4 text-center">
              ...
              <div className="text-2xl font-bold">{Math.round(totalStats.averageSpeed)}</div>
            ...
            <Card className="p-4 text-center">
              ...
              <div className="text-2xl font-bold">{totalStats.unlockedAchievements}</div>
              <div className="text-sm text-gray-600">إنجاز محقق</div>
            </Card>
            <Card className="p-4 text-center">
              <Eye className="w-8 h-8 mx-auto text-indigo-500 mb-2" />
              <div className="text-2xl font-bold">{Math.round(totalStats.totalWords / 1000)}K</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-semibold mb-4">توزيع القراءة حسب السلسلة</h3>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    data={seriesData}
                    ...
                    <div className="flex-1">
                      ...
                      {isUnlocked && (
                        <div className="flex items-center gap-2 text-sm text-green-600">
                          ...
                          محقق في {achievement.unlockedAt!.toLocaleDateString('ar')}
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <Card key={goal.id} className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold">
                      الهدف ال{goal.type === 'daily' ? 'يومي' : 
                               goal.type === 'weekly' ? 'أسبوعي' : 
                    ...
                    <div className="flex-1">
                      ...
                      {insight.actionable && (
                        <div className="bg-white p-3 rounded-lg border-l-2 border-blue-300">
                          <div className="font-medium text-sm text-blue-800 mb-1">إجراء مقترح:</div>
