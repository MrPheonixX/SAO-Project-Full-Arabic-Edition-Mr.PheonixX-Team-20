...
const SimpleDevToolsBlocker: React.FC = () => {
  useEffect(() => {
    ...
    if (isDeveloperMode()) {
      console.log('🔧 Developer mode active - Security disabled for development');
      return;
    }
    ...
    console.log('%c🛡️ Content Protection Active', 'color: #3b82f6; font-size: 16px; font-weight: bold;');
    console.log('%cThis website is protected by MrPheonixX © 2024', 'color: #6b7280; font-size: 12px;');
    console.log('%cFor developers: Use Ctrl+Shift+Alt+D or call enableDeveloperMode("password")', 'color: #10b981; font-size: 12px;');
