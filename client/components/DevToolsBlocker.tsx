...
const DevToolsBlocker: React.FC = () => {
  useEffect(() => {
    ...
    const disableDevMessages = () => {
      ...
      const methods = ['log', 'debug', 'info', 'warn', 'error', 'table', 'trace', 'dir', 'group', 'groupCollapsed', 'groupEnd', 'clear', 'count', 'countReset', 'time', 'timeEnd', 'timeLog', 'timeStamp', 'profile', 'profileEnd', 'assert'];
    ...
    console.log('%cهذا الموقع محمي بحقوق الطبع والنشر', 'color: red; font-size: 20px;');
    console.log('%cأي محاولة لسرقة المحتوى أو الكود ستؤدي لحجب الوصول', 'color: red; font-size: 16px;');
    console.log('%c© MrPheonixX 2024', 'color: red; font-size: 16px; font-weight: bold;');
